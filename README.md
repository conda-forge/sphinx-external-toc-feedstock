...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-external-toc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12578&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-external-toc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-external-toc` can be installed with:

```
conda install sphinx-external-toc
```

It is possible to list all of the versions of `sphinx-external-toc` available on your platform with:
